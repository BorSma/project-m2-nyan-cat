...
class Enemy {
  ...
  constructor(theRoot, enemySpot) {
    ...
    //Scored is used when the enemy passes the bottom of the screen. Not really used anymore...remove?
    this.scored = false;

    //Collision is used when there is a collission between the shot and the enemy.
    this.collision = false;

    //Clear is used when restarting the game. This flags the enemy for removal.
    this.clear = false;
  ...
  update(timeDiff) {
    //console.log(`The enemy X is: ${this.x}`);
