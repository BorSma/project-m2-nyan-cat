// The Shot class will contain information about the enemy such as
...
class Shot {
  ...
  constructor(theRoot, shotSpot) {
    ...
    this.domElement.setAttribute("class","cheese");
  ...
  update(timeDiff) {
    //console.log(`The shots X is: ${this.x}`);
